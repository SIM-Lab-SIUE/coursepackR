...
In the previous lab, you "wrangled" your data—cleaning it and creating new variables. Now comes the fun part: telling the story of that data.
...
**The Grammar of Graphics:** `ggplot()` works in layers, like painting on a canvas:
