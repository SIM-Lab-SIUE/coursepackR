...
![The Keystone Concept](images/research-keystone.png){fig-alt="The Keystone Concept" width="100%"}
...
![Exploration vs. Prediction](images/exploration-vs-prediction.png){fig-alt="Exploration vs. Prediction" width="100%"}
...
![The Null Hypothesis Benchmark](images/null-hypothesis-scale.png){fig-alt="The Null Hypothesis Benchmark" width="100%"}
...
![The Qualitative Interview](images/qualitative-interview.png){fig-alt="The Qualitative Interview" width="100%"}
