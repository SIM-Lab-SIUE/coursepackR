...
vignette: >
  %\VignetteIndexEntry{Building Your Course}
...
coursepackR provides a flexible template for building R-based course packages. The recommended structure:
...
- See [Textbook Integration](textbook-integration.html) for incorporating OER content
