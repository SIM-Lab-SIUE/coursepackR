...
vignette: >
  %\VignetteIndexEntry{Textbook Integration}
...
coursepackR includes "From Vibes to Variables: A Field Guide to Open Media Science" - a 14-chapter Open Educational Resource (CC-BY) designed for teaching research methods in communication and social sciences.
...
4. **Analysis** (Weeks 11-14): Variables, testing, interpretation, reporting
...
- ✓ Adapt chapters for your context
- ✓ Add discipline-specific examples
- ✓ Translate to other languages
- ✓ Remix with other OER content

**Attribution required**: Credit "AP Leith, coursepackR" when using or adapting.
...
Review the example weeks in `inst/courses/template_course/` to see textbook integration in practice.
