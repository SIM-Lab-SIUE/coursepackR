...
# Chapter 14: Inferential Statistics (Modernized)

This chapter covers the basics of inferential statistics using the course dataset. We will use the `pew_wrangled` object you created in Lab 12, and all code and examples now use the new Pew dataset and valid columns.

## 1. Chi-Square Test Example
