...
- A research question grounded in theory (Chapter 7)
- 200 songs systematically coded using a pilot-tested codebook (Chapters 14-15)
- Cleaned data in R (Chapter 17)
- Visualizations showing patterns (Chapter 18)
- Statistical tests quantifying relationships (Chapter 19)
- Effect sizes contextualizing findings (Chapter 20)
- An honest interpretation acknowledging limitations (Chapter 20)
...
This chapter teaches you to create professional research reports that embody the reproducibility principles you've practiced throughout this book. The ethical obligations discussed in Chapter 8 (transparent reporting, no selective presentation) are structurally enforced when your analysis code is embedded in your report: every decision is visible, every step is auditable.

## What is Quarto?

**Quarto** is a scientific publishing system that turns plain text files into polished documents: PDFs, HTML web pages, Word documents, presentations, even books (this textbook is built with Quarto).
...
- The course Zotero library contains pre-formatted entries for all sources used in this textbook
...
**Solution**: Ensure data is loaded in an early chunk before any analysis chunks.
...
### Exercise 21.2: Tables and Figures
...
### Exercise 21.3: Inline Statistics

Write a Results paragraph that:

1. Stores a chi-square or correlation result in a hidden chunk
2. Reports the statistics inline using `` `r variable` `` syntax
3. Includes test statistic, df, p-value, effect size, and means
4. Follows APA reporting format (Chapter 19)

---

### Exercise 21.4: Citations
...
4. **The Portfolio as Professional Tool**: This report isn't just a class assignment. It's a demonstration of your ability to design, execute, and communicate research. How would you adapt this portfolio for a job interview? For a graduate school application? For a conference submission?
...
**Required Task**: Produce a conference-quality version of your research report.

**Background**: Academic conferences (ICA, NCA, AEJMC) accept paper submissions that follow specific formatting requirements: typically 25-30 double-spaced pages, APA formatting, a 150-word abstract, and blind review (no author identifying information in the manuscript body). Producing a submission-ready manuscript from your Quarto report requires adapting both the content and the formatting.

**Steps**:

1. **Write a conference abstract** (150 words maximum). The abstract must include: the research question, method (content analysis of N songs, time period), key finding(s) with effect sizes, and one sentence about the study's contribution. Every word counts at 150 words; practice precision.

2. **Format for submission**: Modify your Quarto YAML to produce a double-spaced, 12-point, Times New Roman PDF with 1-inch margins and APA-style section headings. Ensure author information appears on a title page but not in the manuscript body (for blind review). The following YAML settings are a starting point:
...
3. **Create a supplementary materials document**: Produce a separate Quarto document containing your complete codebook, sample coding sheet, reliability statistics for every variable, and any analyses mentioned but not fully reported in the main manuscript. This supplements the main paper and demonstrates methodological rigor.

4. **Write a plain-language summary** (200 words) of your findings for a non-academic audience (e.g., a music industry blog, a university press release, or a social media thread). How does the language, framing, and level of detail change when you write for a general audience rather than an academic one? What do you gain and lose in translation?

5. **Reflect on the gap**: Compare your conference manuscript to your course portfolio. What did you add, cut, or restructure? What does this tell you about the difference between a course deliverable and a professional research product?
...
Chapter 22 (Going Live) concludes the textbook with research dissemination and sharing. You've created a reproducible research report; now you'll learn to share it responsibly. This final chapter covers archiving data and code on the Open Science Framework and GitHub, writing for different audiences, creating online research portfolios, ethical considerations in sharing findings, and understanding open science practices. You'll learn how to make your work discoverable, reproducible, and impactful beyond the classroom.
