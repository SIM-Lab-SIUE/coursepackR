...
## 2. Chi-Square Test
Use the `chisq.test()` function to test the relationship between party identification and TikTok use. Use the `party_simple` and `USE_TIKTOK` variables in your `pew_wrangled` dataset.
