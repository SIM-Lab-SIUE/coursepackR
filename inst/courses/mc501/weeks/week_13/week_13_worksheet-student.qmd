...
```{r viz-bar-count}
ggplot(w144_clean, aes(x = platform_count)) +
...
```{r viz-boxplot-group}
ggplot(w144_clean, aes(x = major, y = platform_count)) +
...
```{r viz-stacked-bar}
ggplot(w144_clean, aes(x = major, fill = year)) +
...
```{r viz-scatter-color}
ggplot(w144_clean, aes(x = age, y = platform_count, color = major)) +
